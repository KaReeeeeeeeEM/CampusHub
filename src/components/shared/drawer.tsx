      ...
      <DrawerPrimitive.Portal>
        ...
        <DrawerPrimitive.Content
          className={cn(
            ...
            direction === "bottom" && "bottom-0 left-0 h-auto max-h-[85vh] max-w-none rounded-t-lg border-t",
            direction === "top" && "left-0 top-0 h-auto max-h-[85vh] max-w-none rounded-b-lg border-b",
            className
          )}
        >
