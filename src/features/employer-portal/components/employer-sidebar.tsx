...
} from "@/features/employer-portal/lib/navigation";
import { cn } from "@/lib/utils";
import { useNavigationStore } from "@/store/navigation-store";
import type { AuthUser } from "@/types/auth";

function isActive(pathname: string, item: EmployerNavItem) {
...
export function EmployerSidebar({ className, user }: EmployerSidebarProps) {
