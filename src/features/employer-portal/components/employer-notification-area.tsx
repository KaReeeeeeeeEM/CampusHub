...
export function EmployerNotificationArea() {
  const [notifications, setNotifications] = useState<
    Array<{ id: string; title: string; body: string; unread: boolean }>
  >([]);
  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button
          aria-label="Open employer notifications"
          className="relative"
          size="icon"
          variant="ghost"
        >
          ...
          <div className="flex items-start justify-between gap-3">
            <div>
              ...
              <p className="mt-1 text-xs text-muted-foreground">
                {unreadCount} unread recruitment updates
              </p>
            </div>
            <Button
              asChild
              ...
              variant="ghost"
            >
              <Link href="/employer/notifications">View all</Link>
            </Button>
          </div>
