...
export function AlumniNotificationArea() {
  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button
          aria-label="Open alumni notifications"
          className="relative"
          size="icon"
          variant="ghost"
        >
          ...
          <div className="flex items-start justify-between gap-3">
            <div>
              ...
              <p className="mt-1 text-xs text-muted-foreground">
                {unreadCount} unread alumni updates
              </p>
            </div>
            <Button
              asChild
              ...
              variant="ghost"
            >
              <Link href="/alumni/notifications">View all</Link>
            </Button>
          </div>
