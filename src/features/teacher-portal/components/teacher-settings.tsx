...
export function TeacherSettings() {
  ...
  return (
    <section className="mt-8 space-y-5">
        ...
        {settingsTabs.map((tab) => {
          ...
          return (
            <Button
              ...
              aria-controls={`teacher-settings-${tab.key}`}
              id={`teacher-settings-tab-${tab.key}`}
      ...
      <Card
        role="tabpanel"
        id={`teacher-settings-${activeTabConfig.key}`}
        aria-labelledby={`teacher-settings-tab-${activeTabConfig.key}`}
      >
        <CardHeader>
