...
export const almanacHighlights = [
  ...
  },
  {
    ...
    date: "Aug 14",
    description: "Briefing for students preparing field placement documentation."
  }
];
...
export const notifications = [
  {
    ...
    description: "Add student ID verification and interests to unlock better recommendations.",
    icon: Bell
  },
  {
    title: "New opportunity matches your department",
    description: "Graduate trainee talent pool opened for ICT and engineering students.",
    icon: BriefcaseBusiness
  },
  {
    title: "Representative feedback window open",
    description: "Submit academic experience feedback for your college representative.",
    icon: MessageSquareText
  }
];

export const quickActions = [
  { label: "View almanac", description: "Academic dates", icon: CalendarDays },
  { label: "Find campus office", description: "Map access", icon: Map },
  { label: "Course resources", description: "Learning materials", icon: BookOpen },
  { label: "Submit feedback", description: "Representative channel", icon: FileText }
];

export const futureModules = [
  {
    title: "Forum",
    description: "Student communities, discussions, and moderated academic spaces.",
    icon: MessageSquareText
  },
  {
    title: "Suggestions",
    description: "Structured feedback and improvement requests for campus leadership.",
    icon: Lightbulb
  },
  {
    title: "Opportunities",
    description: "Internships, competitions, scholarships, and student programs.",
    icon: BriefcaseBusiness
  },
  {
    title: "Alumni",
