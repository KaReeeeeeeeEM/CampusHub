...
const settingsTabs = [
  {
    key: "security",
    label: "Security",
    description: "Passkeys and authenticator app protection.",
    icon: FiLock,
  },
  {
    key: "notifications",
    label: "Notifications",
    description: "Browser push and in-app notification preferences.",
    icon: FiBell,
  },
] as const;
  ...
  return (
    <section className="mt-8 space-y-5">
      <div
        ...
        role="tablist"
        aria-label="Campus admin settings"
      >
        {settingsTabs.map((tab) => {
          ...
          return (
            <Button
              ...
              aria-controls={`campus-admin-settings-${tab.key}`}
              id={`campus-admin-settings-tab-${tab.key}`}
      ...
      <Card
        role="tabpanel"
        id={`campus-admin-settings-${activeTabConfig.key}`}
        aria-labelledby={`campus-admin-settings-tab-${activeTabConfig.key}`}
      >
        <CardHeader>
